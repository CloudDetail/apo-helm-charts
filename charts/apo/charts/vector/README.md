...
| args | list | `["-w","--config-dir","/etc/vector/"]` | Override Vector's default arguments. |
...
| serviceHeadless.enabled | bool | `false` | If true, create and provide a Headless Service resource for Vector. |
