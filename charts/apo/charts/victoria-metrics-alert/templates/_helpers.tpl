...
{{- else -}}
{{- printf "apo-%s" $name | trunc 63 | trimSuffix "-" -}}
{{- end -}}
{{- end -}}
{{- end -}}
...
{{- $name := default .Chart.Name .Values.nameOverride -}}
{{- if contains $name .Release.Name -}}
{{- printf "apo-%s" .Values.server.name | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- printf "apo-%s-%s" $name .Values.server.name | trunc 63 | trimSuffix "-" -}}
{{- end -}}
{{- end -}}
{{- end -}}
