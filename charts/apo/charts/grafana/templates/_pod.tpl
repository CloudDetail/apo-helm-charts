...
{{- if .Values.dashboards }}
  - name: download-dashboards
    image: "{{ tpl .Values.downloadDashboardsImage.registry . }}/{{ tpl .Values.downloadDashboardsImage.repository . }}:{{ tpl .Values.downloadDashboardsImage.tag . }}"
    imagePullPolicy: {{ tpl .Values.downloadDashboardsImage.pullPolicy . }}
    command: ["/bin/sh"]
...
{{- end}}
  - name: {{ .Chart.Name }}
    image: "{{ tpl .Values.image.registry . }}/{{ tpl .Values.image.repository . }}:{{ tpl .Values.image.tag . | default .Chart.AppVersion }}"
