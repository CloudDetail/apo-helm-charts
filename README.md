...
|-----|------|---------|-------------|
| altinity-clickhouse-operator.affinity | object | `{}` |  |
| altinity-clickhouse-operator.clickhouse.affinity | object | `{}` |  |
...
| altinity-clickhouse-operator.clickhouse.nodeSelector | object | `{}` |  |
| altinity-clickhouse-operator.clickhouse.password | string | `"{{ .Values.global.clickhouse.password }}"` |  |
...
| altinity-clickhouse-operator.clickhouse.persistence.data.storageClass | string | `"{{ .Values.global.persistence.storageClass }}"` | StorageClass to use for persistent volume. Requires clickhouse.persistence.enabled: true. If defined, PVC created automatically |
...
| altinity-clickhouse-operator.clickhouse.persistence.log.storageClass | string | `"{{ .Values.global.persistence.storageClass }}"` | StorageClass to use for persistent volume. Requires clickhouse.persistence.enabled: true. If defined, PVC created automatically |
| altinity-clickhouse-operator.clickhouse.tolerations | list | `[]` |  |
| altinity-clickhouse-operator.clickhouse.username | string | `"{{ .Values.global.clickhouse.username }}"` |  |
...
| altinity-clickhouse-operator.nodeSelector | object | `{}` |  |
...
| altinity-clickhouse-operator.tolerations | list | `[]` |  |
| apo-backend.affinity | object | `{}` |  |
...
| apo-backend.apoBackend.image.tag | string | `"v1.3.0"` |  |
...
| apo-backend.apoPolarisAnalyzer.image.tag | string | `"v1.1.0"` |  |
| apo-backend.config.anonymousUserEnabled | string | `"false"` |  |
| apo-backend.config.clickhousePassword | string | `"{{ .Values.global.clickhouse.password }}"` |  |
| apo-backend.config.clickhouseUrl | string | `"{{ .Values.global.clickhouse.host }}:{{ .Values.global.clickhouse.nativePort }}"` |  |
| apo-backend.config.clickhouseUsername | string | `"{{ .Values.global.clickhouse.username }}"` |  |
...
| apo-backend.nodeSelector | object | `{}` |  |
...
| apo-backend.persistence.storageClass | string | `"{{ .Values.global.persistence.storageClass }}"` | StorageClass to use for persistent volume. Requires clickhouse.persistence.enabled: true. If defined, PVC created automatically |
| apo-backend.service.nodePort | int | `31363` |  |
| apo-backend.service.type | string | `"NodePort"` |  |
| apo-backend.tolerations | list | `[]` |  |
| apo-collector.affinity | object | `{}` |  |
...
| apo-collector.apoApmAdapter.image.tag | string | `"v1.7.1"` |  |
...
| apo-collector.apoCollector.config.clickhousePassword | string | `"{{ .Values.global.clickhouse.password }}"` |  |
| apo-collector.apoCollector.config.clickhouseUrl | string | `"{{ .Values.global.clickhouse.host }}:{{ .Values.global.clickhouse.nativePort }}"` |  |
| apo-collector.apoCollector.config.clickhouseUsername | string | `"{{ .Values.global.clickhouse.username }}"` |  |
...
| apo-collector.apoCollector.image.tag | string | `"v1.7.2"` |  |
...
| apo-collector.nodeSelector | object | `{}` |  |
| apo-collector.tolerations | list | `[]` |  |
| apo-front.affinity | object | `{}` |  |
...
| apo-front.image.tag | string | `"v1.3.0"` |  |
| apo-front.nodeSelector | object | `{}` |  |
| apo-front.service.nodePort | int | `31364` |  |
| apo-front.service.type | string | `"NodePort"` |  |
| apo-front.tolerations | list | `[]` |  |
| apo-jaeger-collector.affinity | object | `{}` |  |
| apo-jaeger-collector.config.clickhousePassword | string | `"{{ .Values.global.clickhouse.password }}"` |  |
| apo-jaeger-collector.config.clickhouseUrl | string | `"{{ .Values.global.clickhouse.host }}:{{ .Values.global.clickhouse.nativePort }}"` |  |
| apo-jaeger-collector.config.clickhouseUsername | string | `"{{ .Values.global.clickhouse.username }}"` |  |
...
| apo-jaeger-collector.nodeSelector | object | `{}` |  |
...
| apo-jaeger-collector.tolerations | list | `[]` |  |
| apo-one-agent.affinity | object | `{}` |  |
...
| apo-one-agent.apoIlogtail.image.tag | string | `"v1.5.2"` |  |
...
| apo-one-agent.apoNodeAgent.image.tag | string | `"v1.8.0"` |  |
...
| apo-one-agent.apoOneAgent.config.apoCollectorUrl | string | `"apo-collector-svc.{{ .Release.Namespace }}"` |  |
...
| apo-one-agent.grafanaAlloy.image.tag | string | `"v1.4.2-1"` |  |
...
| apo-one-agent.grafanaBeyla.config.k8sNamespace | string | `"^/(/?/!{{ .Release.Namespace }}$).*"` |  |
| apo-one-agent.grafanaBeyla.enabled | bool | `false` |  |
...
| apo-one-agent.nodeSelector | object | `{}` |  |
...
| apo-one-agent.odiglet.image.tag | string | `"v1.0.2"` |  |
...
| apo-one-agent.tolerations | list | `[]` |  |
| apo-otel-collector-gateway.affinity | object | `{}` |  |
...
| apo-otel-collector-gateway.config.clickhousePassword | string | `"{{ .Values.global.clickhouse.password }}"` |  |
| apo-otel-collector-gateway.config.clickhouseUrl | string | `"{{ .Values.global.clickhouse.host }}:{{ .Values.global.clickhouse.nativePort }}"` |  |
| apo-otel-collector-gateway.config.clickhouseUsername | string | `"{{ .Values.global.clickhouse.username }}"` |  |
...
| apo-otel-collector-gateway.nodeSelector | object | `{}` |  |
...
| apo-otel-collector-gateway.tolerations | list | `[]` |  |
...
| global.clickhouse.clusterName | string | `""` |  |
| global.clickhouse.database | string | `"apo"` |  |
| global.clickhouse.host | string | `"apo-clickhouse-svc"` |  |
| global.clickhouse.httpPort | int | `8123` |  |
| global.clickhouse.nativePort | int | `9000` |  |
| global.clickhouse.password | string | `"WPKf-e9U.X)K)ezTDo9#"` |  |
| global.clickhouse.replication | string | `"false"` |  |
| global.clickhouse.username | string | `"admin"` |  |
...
| global.victoriaMetrics.cluster.insertUrl | string | `"http://write-service-url:8080/insert/0/prometheus/"` |  |
| global.victoriaMetrics.cluster.selectUrl | string | `"http://read-service-url:8080/select/0/prometheus/"` |  |
| global.victoriaMetrics.mode | string | `"single"` |  |
| global.victoriaMetrics.single.url | string | `"http://apo-victoria-metrics-single-server-svc:8428"` |  |
| grafana."grafana.ini".server.domain | string | `"localhost"` |  |
| grafana.affinity | object | `{}` |  |
| grafana.enabled | bool | `true` |  |
| grafana.extraInitContainers[0].image | string | `"{{ .Values.global.image.repository }}/apo-grafana-init-dashboards:v1.1.1"` |  |
...
| grafana.extraInitContainers[0].volumeMounts[1].mountPath | string | `"/var/lib/grafana/plugins"` |  |
| grafana.extraInitContainers[0].volumeMounts[1].name | string | `"apo-plugins"` |  |
...
| originx-copilot-ai.affinity | object | `{}` |  |
...
| originx-copilot-ai.image.tag | string | `"v1.1.0"` |  |
| originx-copilot-ai.nodeSelector | object | `{}` |  |
...
| originx-copilot-ai.tolerations | list | `[]` |  |
| originx-root-cause-infer.affinity | object | `{}` |  |
...
| originx-root-cause-infer.image.tag | string | `"v1.6.4"` |  |
...
| originx-root-cause-infer.nodeSelector | object | `{}` |  |
...
| originx-root-cause-infer.tolerations | list | `[]` |  |
| vector.affinity | object | `{}` |  |
| vector.clickhousePassword | string | `"{{ .Values.global.clickhouse.password }}"` |  |
| vector.clickhouseUrl | string | `"{{ .Values.global.clickhouse.host }}:{{ .Values.global.clickhouse.nativePort }}"` |  |
| vector.clickhouseUsername | string | `"{{ .Values.global.clickhouse.username }}"` |  |
...
| victoria-metrics-alert.affinity | object | `{}` |  |
...
| victoria-metrics-alert.nodeSelector | object | `{}` |  |
...
| victoria-metrics-alert.tolerations | list | `[]` |  |
| victoria-metrics-single.affinity | object | `{}` |  |
| victoria-metrics-single.enabled | bool | `true` |  |
| victoria-metrics-single.nodeSelector | object | `{}` |  |
| victoria-metrics-single.rbac.create | bool | `false` |  |
| victoria-metrics-single.server.extraArgs."envflag.enable" | string | `"true"` |  |
| victoria-metrics-single.server.extraArgs."envflag.prefix" | string | `"VM_"` |  |
| victoria-metrics-single.server.extraArgs."search.maxSeries" | int | `100000` |  |
| victoria-metrics-single.server.extraArgs.loggerFormat | string | `"json"` |  |
...
| victoria-metrics-single.server.persistentVolume.storageClass | string | `"{{ .Values.global.persistence.storageClass }}"` | StorageClass to use for persistent volume. Requires server.persistentVolume.enabled: true. If defined, PVC created automatically |
...
| victoria-metrics-single.tolerations | list | `[]` |  |
